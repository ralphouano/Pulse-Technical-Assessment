...
async function sendDecline(targetId: string, initiatorId: string, reason: string | null = null) {
  await prisma.signal.create({
    data: { fromId: targetId, toId: initiatorId, type: "decline", payload: reason },
  });
}
